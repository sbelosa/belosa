...
class BiolinkBlockAjax extends Controller {
    ...
    private function update_biolink_link_app_switcher() {
        ...
        $settings = json_encode([
            ...
            'border_style' => $_POST['border_style'],
            'border_color' => $_POST['border_color'],
            'border_shadow_style' => $_POST['border_width'] ? 'subtle' : ($biolink_block->settings->border_shadow_style ?? 'subtle'),
            'border_shadow_color' => $biolink_block->settings->border_shadow_color ?? '#00000010',
            'animation' => $_POST['animation'],
            'animation_runs' => $_POST['animation_runs'],
            'icon' => $_POST['icon'],
            'image' => $db_image,
