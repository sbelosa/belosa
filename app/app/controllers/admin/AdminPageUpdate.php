    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if($pages_has_image_columns) {
                $page->image = \Altum\Uploads::process_upload($page->image, 'pages', 'image', 'image_remove', null);
            }
            /* /Custom code: FC-2026-02-24 */
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                /* Custom code: FC-2026-02-24: pages thumbnails */
                if($pages_has_image_columns) {
                    $update_data['image'] = $page->image;
                    $update_data['image_description'] = $_POST['image_description'];
                }
                /* /Custom code: FC-2026-02-24 */

                db()->where('page_id', $page->page_id)->update('pages', $update_data);
