...
class PersonalNotificationCreate extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $required_fields = ['subscriber_id', 'name', 'title', 'description'];
            ...
            /* Uploaded image */
            $image = \Altum\Uploads::process_upload(null, 'websites_personal_notifications_images', 'image', 'image_remove', settings()->websites->personal_notification_images_limit);
        ...
        $values = [
            ...
            'subscriber_id' => $_POST['subscriber_id'] ?? $_GET['subscriber_id'] ?? null,
        ...
        $view = new \Altum\View('personal-notification-create/index', (array) $this);
