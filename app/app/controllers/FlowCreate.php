...
class FlowCreate extends Controller {
    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $_POST['auto_apply_to_matching'] = (int) isset($_POST['auto_apply_to_matching']);
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                ...
                if($_POST['auto_apply_to_matching']) {
                    db()->where('user_id', $this->user->user_id)->update('subscribers', [
        ...
        $values = [
            ...
            'auto_apply_to_matching' => $_POST['auto_apply_to_matching'] ?? false,
