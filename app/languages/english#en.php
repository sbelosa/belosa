...
return [
	...
	'fcc_results.subheader' => 'Track qualification and ranking of webshop clicks from your Forever Card Apps.',
	'fcc_results.period_7d' => '7 days',
	'fcc_results.period_30d' => '30 days',
	'fcc_results.qualification_note' => 'The list includes collaborators with at least %s unique webshop clicks in the selected period.',
	...
	'fcc_results.table.shop_clicks' => 'Webshop clicks',
	...
	'fcc_results.you.shop_clicks' => 'Webshop clicks',
	...
	'fcc_results.homepage_spotlight_notice_before' => 'Qualified results help identify active apps, while public proof examples are shown on the',
	'fcc_results.homepage_spotlight_notice_after' => 'page when the member opts in and the app is approved.',
	'fcc_results.proof_note' => 'FCC Results are activity metrics, while Featured Apps is a public proof hub that requires member consent and an additional real-world usage summary.',
	/* Custom code: FC-2026-03-14: FCC metrics definitions */
	'fcc_results.metrics_note' => 'Qualification and ranking use unique webshop clicks. CTR shows what share of unique visits to your app ends with a webshop click.',
	'fcc_results.metrics_info.title' => 'How it is calculated',
	'fcc_results.metrics_info.position' => 'Position: your place in the list based on webshop clicks in the selected period (7 or 30 days).',
	'fcc_results.metrics_info.shop_clicks' => 'Webshop clicks: unique clicks on webshop blocks from your Forever Card Apps are counted.',
	'fcc_results.metrics_info.ctr' => 'CTR shows what percentage of unique visits to your app ends with a webshop click. Formula: unique webshop clicks / unique FCC App visits × 100.',
	'fcc_results.metrics_info.trend' => 'Trend: change in webshop clicks compared to the previous same-length period.',
	'fcc_results.metrics_info.to_qualification' => 'To qualification: how many webshop clicks are left to reach the threshold of 15.',
	'fcc_results.metrics_info.to_next_rank' => 'To next rank: how many webshop clicks you need to pass the user directly above you.',
	...
	'fcc_results.challenge.text' => 'Reach %s unique webshop clicks in 7 days and enter the qualified list.',
	/* /Custom code: FC-2026-03-14 */
	/* Custom code: FC-2026-03-31: AI plan phase 1 user module translations */
	'ai_plan.menu' => 'My next step',
	'ai_plan.title' => 'My next step',
	'ai_plan.header' => 'My next step',
	...
	'ai_plan.status_ready' => 'Signal ready',
	'ai_plan.status_building' => 'Building signal',
	'ai_plan.hero_title' => 'Your strategic profile for personalized AI coaching',
	'ai_plan.hero_text' => 'This first phase captures the context analytics cannot know on its own: your goal, audience, channels, communication style, and real constraints. That becomes the foundation for your next weekly step.',
	'ai_plan.hero_title_phase_3' => 'Your next step for the next 7 days',
	'ai_plan.hero_text_phase_3' => 'Phase 3 combines your profile, weekly check-in, real signal, and app structure so AI can return a concrete working plan for this week.',
	...
	'ai_plan.guide_profile_text' => 'Start by completing the core profile. This is the base AI needs to understand your goal, audience, and focus.',
	'ai_plan.guide_weekly_text' => 'The profile is ready. Now complete the weekly check-in so AI can build this week\'s plan.',
	'ai_plan.guide_weekly_locked_text' => 'The profile is done, but the weekly check-in is not available yet. When the conditions are ready, the next step will open here.',
	'ai_plan.guide_plan_text' => 'The weekly check-in is saved. Now open and review your plan for the next 7 days.',
	'ai_plan.guide_outcome_text' => 'The plan is ready. After you start working through it, record what actually worked so the next plan becomes better.',
	...
	'ai_plan.step_plan_text' => 'Open the plan, work through it, and then save the real weekly outcome.',
	...
	'ai_plan.optional_tool_title' => 'Optional tool: AI app review',
	'ai_plan.optional_tool_text' => 'This is not required for the next step, but it helps if you want extra recommendations on how to improve the app.',
	'ai_plan.metric_clicks' => 'Webshop clicks in the last 30 days',
	...
	'ai_plan.metric_help' => 'In phase 2 we can gate the full weekly plan for collaborators with stronger signal, but everyone can complete the profile now.',
	'ai_plan.metric_help_phase_3' => 'Once you save the weekly check-in, AI builds the weekly plan immediately and you can regenerate it without a new weekly submission.',
	'ai_plan.app_review_title' => 'AI review of your app',
	'ai_plan.app_review_text' => 'The manual AI app review uses your goal, app structure, and real link analytics. Frequency and app selection depend on the active package.',
	'ai_plan.app_review_helper' => 'This is the best way to improve the app before the first 15 clicks and reach quality interest faster.',
	'ai_plan.app_review_plan_admin' => 'Admin test mode: unlimited review',
	'ai_plan.app_review_plan_pro' => 'PRO plan 5: daily review',
	'ai_plan.app_review_plan_beginner' => 'Beginner plan: weekly review',
	'ai_plan.app_review_scope_multiple' => 'You can choose any of your apps',
	'ai_plan.app_review_scope_main' => 'The review uses your main app',
	...
	'ai_plan.app_review_admin_testing_text' => 'As admin, you can run analyses continuously and choose any app so the flow can be tested without package or cooldown limits.',
	...
	'ai_plan.app_review_generate' => 'Run AI app review',
	'ai_plan.app_review_footer' => 'AI returns one main recommendation, 3 priorities, an ideal block order, and short visual guidance.',
	...
	'ai_plan.form_text' => 'Choose what best describes your current situation. This form stays intentionally short so we can extend it later with weekly adaptive questions.',
	...
	'ai_plan.form_footer' => 'After this phase we move to weekly check-ins and a plan generated from analytics plus your business context.',
	...
	'ai_plan.analytics_title' => 'What the data currently shows most clearly',
	...
	'ai_plan.analytics_help' => 'AI reads this together with your weekly answers and the current setup you already use in the app.',
	...
	'ai_plan.plan_pending_text' => 'A weekly check-in exists, but the plan is not saved yet. You can generate it manually.',
