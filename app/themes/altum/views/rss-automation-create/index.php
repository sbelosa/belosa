        ...
        <div class="card-body">
            ...
            <form id="rss_automation_create" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="collapse" data-parent="#rss_automation_create" id="rss_container">
                    ...
                    <div class="form-group custom-control custom-switch">
                        <input id="disable_rss_automation_on_fail" name="disable_rss_automation_on_fail" type="checkbox" class="custom-control-input" <?= $data->values['disable_rss_automation_on_fail'] ? 'checked="checked"' : null?>>
