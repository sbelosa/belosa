...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    ...
    <div class="d-flex position-relative d-print-none">
        ...
        <div class="ml-3">
            <div class="dropdown">
                <button type="button" class="btn <?= $data->filters->has_applied_filters ? 'btn-dark' : 'btn-gray-300' ?> filters-button dropdown-toggle-simple <?= count($data->websites) || $data->filters->has_applied_filters ? null : 'disabled' ?>" data-toggle="dropdown" data-boundary="viewport" data-tooltip data-html="true" title="<?= l('global.filters.tooltip') ?>" data-tooltip-hide-on-click>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="<?= url('admin/personal-notifications?website_id=' . $row->website_id) ?>" class="mr-2" data-toggle="tooltip" title="<?= l('admin_personal_notifications.menu') ?>">
