...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    ...
    <div class="d-flex position-relative d-print-none">
        <div class="ml-3">
            <a href="<?= url('admin/statistics/recurring_campaigns') ?>" class="btn btn-gray-300" data-tooltip title="<?= l('global.statistics') ?>">
                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="order_by" id="filters_order_by" class="custom-select custom-select-sm">
                                ...
                                <option value="next_run_datetime" <?= $data->filters->order_by == 'next_run_datetime' ? 'selected="selected"' : null ?>><?= l('recurring_campaigns.next_run_datetime') ?></option>                                    <option value="name" <?= $data->filters->order_by == 'name' ? 'selected="selected"' : null ?>><?= l('global.name') ?></option>
            ...
            <table class="table table-custom">
                ...
                <?php foreach($data->recurring_campaigns as $row): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="<?= url('admin/campaigns?recurring_campaign_id=' . $row->recurring_campaign_id) ?>" class="badge bg-campaign text-campaign">
                                <i class="fas fa-fw fa-sm fa-rocket mr-1"></i> <?= nr($row->total_campaigns) ?>
                            </a>
                        </td>

                        <td class="text-nowrap">
                            <a href="<?= url('admin/subscribers-logs?recurring_campaign_id=' . $row->recurring_campaign_id) ?>" class="badge text-notification bg-notification">
