...
<div class="d-flex flex-column flex-md-row justify-content-between mb-4">
    ...
    <div class="d-flex position-relative d-print-none">
        <div class="ml-3">
            <a href="<?= url('admin/statistics/flows') ?>" class="btn btn-gray-300" data-tooltip title="<?= l('global.statistics') ?>">
            ...
            <table class="table table-custom">
                ...
                <?php foreach($data->flows as $row): ?>
                    ...
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="<?= url('admin/subscribers-logs?flow_id=' . $row->flow_id) ?>" class="badge text-notification bg-notification">
