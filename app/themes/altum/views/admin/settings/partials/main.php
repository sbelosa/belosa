...
<div id="main">
    ...
    <div class="collapse" data-parent="#main" id="maintenance_settings_container">
        ...
        <div class="form-group custom-control custom-switch">
            <?php /* Custom code: FC-2026-03-02: dedicated user zone lock mode */ ?>
            <input id="user_zone_maintenance_is_enabled" name="user_zone_maintenance_is_enabled" type="checkbox" class="custom-control-input" <?= (settings()->main->user_zone_maintenance_is_enabled ?? false) ? 'checked="checked"' : null?>>
            <label class="custom-control-label" for="user_zone_maintenance_is_enabled"><?= l('admin_settings.main.user_zone_maintenance_is_enabled') ?></label>
            <small class="form-text text-muted"><?= l('admin_settings.main.user_zone_maintenance_is_enabled_help') ?></small>
        </div>
