        ...
        <div class="<?= settings()->content->blog_columns == 1 ? 'col-12 mb-5' : 'col-12 col-lg-8 mb-lg-0' ?> fcc-blog-main-col">
            ...
            <?php if(settings()->content->blog_share_is_enabled): ?>
                <div class="card mt-4 fcc-glass-card fcc-share-card">
                    <div class="card-body">
                        <?php $is_logged_collaborator = is_logged_in() && user()->type == 0; ?>

                        <?php if($is_logged_collaborator): ?>
                            <div class="mb-3 p-3 rounded position-relative" style="border: 1px solid rgba(65,170,165,0.25); background: rgba(65,170,165,0.06);" id="blog-share-referral-wrapper">
                                <div class="d-flex align-items-center justify-content-between flex-wrap">
                                    <span class="small mb-2 mb-md-0" style="color: #9ee7df;">
                                        <?= l('blog.share_referral.helper_text') ?>
                                    </span>
                                ...
                                <div id="blog-share-referral-popup" class="d-none mt-3 p-3 rounded" style="background: rgba(10, 15, 20, 0.92); border: 1px solid rgba(65,170,165,0.35);">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <div class="pr-2">
                                            <div class="small font-weight-bold mb-2" style="color:#41aaa5;">
                                                <?= l('blog.share_referral.modal_title') ?>
                                            </div>
                                            <div class="small" style="color:#d9f7f3;">
                                                <?= l('blog.share_referral.modal_text') ?>
                                            </div>
                                        </div>

                                        <button type="button" id="blog-share-referral-close" class="btn btn-sm btn-gray-100" style="color:#41aaa5" aria-label="<?= l('global.close') ?>">
           ...
           <?php if (\Altum\Authentication::is_pro() && $data->blog_posts_category && $data->blog_posts_category->show_share_links == 1): ?>
            ...
            <?php
            /* Custom code: FC-2026-02-26: use webshop link whenever available, with referral fallback */
            ...
            ?>
            <?php if ($blog_cta_url): ?>
                <a target="_blank" href="<?= $blog_cta_url ?>" class="mt-5 btn btn-block btn-primary link-btn link-hover-animation link-btn-rounded animate__animated animate__ animate__false animate__delay-2s fcc-cta-btn">                        
                    <span data-icon="">
