    ...
    <?php if(settings()->main->breadcrumbs_is_enabled): ?>
        <nav aria-label="breadcrumb">
            <ol class="custom-breadcrumbs small">
                ...
                <li class="active" aria-current="page"><?= l('subscribers_logs.title') ?></li>
            </ol>
        </nav>
    <?php endif ?>

    <h1 class="h4 mb-4"><?= l('subscribers_logs.title') ?></h1>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                <span class="badge badge-success mr-3">GET</span> <span class="text-muted"><?= SITE_URL ?>api/subscribers-logs/</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div class="card bg-gray-100 border-0">
                            <div class="card-body">
                                curl --request GET \<br />
                                --url '<?= SITE_URL ?>api/subscribers-logs/' \<br />
                    ...
                    <div class="table-responsive table-custom-container mb-4">
                        <table class="table table-custom">
                            ...
                            <tr>
                                ...
                                <td><?= sprintf(l('api_documentation.allowed_values'), '<code>' . implode('</code> , <code>',  ['ip']) . '</code>') ?></td>
                            </tr>
                            <tr>
                                <td>search</td>
                                <td>
                        ...
                        <pre data-shiki="json">
{
    ...
    "links": {
        "first": "<?= SITE_URL ?>api/subscribers-logs?page=1",
        "last": "<?= SITE_URL ?>api/subscribers-logs?page=1",
        "next": null,
        "prev": null,
        "self": "<?= SITE_URL ?>api/subscribers-logs?page=1"
    }
}</pre>
                    </div>
                </div>
