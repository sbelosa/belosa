...
<form id="<?= 'update_biolink_block_' . $row->biolink_block_id ?>" name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="collapse" data-parent="<?= '#update_biolink_block_' . $row->biolink_block_id ?>" id="<?= 'donation_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'donation_title_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-heading text-muted mr-1"></i> <?= l('biolink_donation.title') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_description_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-align-left text-muted mr-1"></i> <?= l('biolink_donation.description') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_prefilled_amount_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-tag text-muted mr-1"></i> <?= l('biolink_donation.prefilled_amount') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_minimum_amount_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-hand-holding-usd text-muted mr-1"></i> <?= l('biolink_donation.minimum_amount') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_currency_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-coins text-muted mr-1"></i> <?= l('biolink_donation.currency') ?></label>
            <select id="<?= 'donation_currency_' . $row->biolink_block_id ?>" name="currency" class="custom-select">
        ...
        <div class="form-group">
            <label for="<?= 'donation_thank_you_title_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-heart text-muted mr-1"></i> <?= l('biolink_donation.thank_you_title') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_thank_you_description_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-comment-alt text-muted mr-1"></i> <?= l('biolink_donation.thank_you_description') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'donation_thank_you_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('biolink_donation.thank_you_url') ?></label>
            <input type="url" id="<?= 'donation_thank_you_url_' . $row->biolink_block_id ?>" name="thank_you_url" class="form-control" value="<?= $row->settings->thank_you_url ?? null ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="<?= $data->biolink_blocks['product']['fields']['thank_you_url']['max_length'] ?>" />
            <small class="form-text text-muted"><?= l('biolink_donation.thank_you_url_help') ?></small>
        </div>

        <div class="mb-3">
            <div class="d-flex flex-wrap flex-row justify-content-between">
                <label for="<?= 'donation_payment_processors_ids_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-credit-card text-muted mr-1"></i> <?= l('payment_processors.payment_processors_ids') ?></label>
    ...
    <div class="collapse" data-parent="<?= '#update_biolink_block_' . $row->biolink_block_id ?>" id="<?= 'donation_data_container_' . $row->biolink_block_id ?>">
