...
<form id="<?= 'update_biolink_block_' . $row->biolink_block_id ?>" name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input id="<?= 'video_poster_url_' . $row->biolink_block_id ?>" type="url" name="poster_url" maxlength="2048" class="form-control" value="<?= $row->settings->poster_url ?>" placeholder="<?= l('global.url_placeholder') ?>" />
    </div>
