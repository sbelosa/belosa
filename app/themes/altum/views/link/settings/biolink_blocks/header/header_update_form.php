...
<form id="<?= 'update_biolink_block_' . $row->biolink_block_id ?>" name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="row btn-group-toggle m-n2" data-toggle="buttons">
            <div class="p-2 col-12 col-lg-4">
                <label class="btn btn-light btn-block font-size-small mb-0 text-truncate <?= $row->settings->background_type == 'image' ? 'active"' : null?>">
            ...
            <div class="p-2 col-12 col-lg-4">
                <label class="btn btn-light btn-block font-size-small mb-0 text-truncate <?= $row->settings->background_type == 'video' ? 'active"' : null?>">
            ...
            <div class="p-2 col-12 col-lg-4">
                <label class="btn btn-light btn-block font-size-small mb-0 text-truncate <?= $row->settings->background_type == 'video_file' ? 'active"' : null?>">
                    <input type="radio" name="background_type" value="video_file" class="custom-control-input" <?= $row->settings->background_type == 'video_file' ? 'checked="checked"' : null?> required="required" />
    ...
    <div data-background-type="video_file" class="form-group">
        ...
        <?= include_view(THEME_PATH . 'views/partials/file_input.php', [
                'id'=> 'header_video_file_' . $row->biolink_block_id,
                'uploads_file_key' => 'files',
                'file_key' => 'video_file',
                'already_existing_file' => $row->settings->video_file ?? null,
                'accept' => \Altum\Uploads::array_to_list_format($data->biolink_blocks['header']['whitelisted_video_extensions']),
        ]) ?>
    ...
    <div class="form-group">
        ...
        <div class="row btn-group-toggle m-n2" data-toggle="buttons">
            ...
            <div class="p-2 col-4">
                <label class="btn btn-light btn-block font-size-small mb-0 text-truncate <?= ($row->settings->object_fit  ?? null) == $object_fit ? 'active"' : null?>">
