    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            $shop_context = $shop_context_supported ? fc_blog_shop_context_encode([
                ...
                'schema_offer_price' => $_POST['shop_context_schema_offer_price'] ?? '',
                'schema_offer_currency' => $_POST['shop_context_schema_offer_currency'] ?? '',
                'schema_shipping_country' => $_POST['shop_context_schema_shipping_country'] ?? '',
                'schema_shipping_price' => $_POST['shop_context_schema_shipping_price'] ?? '',
                'schema_shipping_min_days' => $_POST['shop_context_schema_shipping_min_days'] ?? '',
                'schema_shipping_max_days' => $_POST['shop_context_schema_shipping_max_days'] ?? '',
                'schema_return_country' => $_POST['shop_context_schema_return_country'] ?? '',
                'schema_return_days' => $_POST['shop_context_schema_return_days'] ?? '',
                'schema_return_fees' => $_POST['shop_context_schema_return_fees'] ?? '',
        ...
        if(!empty($_POST)) {
            $shop_context_form_data = array_merge($shop_context_form_data, [
                ...
                'schema_offer_price' => (string) ($_POST['shop_context_schema_offer_price'] ?? ''),
                'schema_offer_currency' => (string) ($_POST['shop_context_schema_offer_currency'] ?? ''),
                'schema_shipping_country' => (string) ($_POST['shop_context_schema_shipping_country'] ?? ''),
                'schema_shipping_price' => (string) ($_POST['shop_context_schema_shipping_price'] ?? ''),
                'schema_shipping_min_days' => (string) ($_POST['shop_context_schema_shipping_min_days'] ?? ''),
                'schema_shipping_max_days' => (string) ($_POST['shop_context_schema_shipping_max_days'] ?? ''),
                'schema_return_country' => (string) ($_POST['shop_context_schema_return_country'] ?? ''),
                'schema_return_days' => (string) ($_POST['shop_context_schema_return_days'] ?? ''),
                'schema_return_fees' => (string) ($_POST['shop_context_schema_return_fees'] ?? ''),
