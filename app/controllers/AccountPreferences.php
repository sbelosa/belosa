    ...
    public function index() {
        ...
        if(!empty($_POST)) {
            ...
            if(!Alerts::has_field_errors() && !Alerts::has_errors()) {
                $preferences = clone $this->user->preferences;

                $preferences->white_label_title = $_POST['white_label_title'];
                $preferences->white_label_logo_light = $this->user->preferences->white_label_logo_light;
                $preferences->white_label_logo_dark = $this->user->preferences->white_label_logo_dark;
                $preferences->white_label_favicon = $this->user->preferences->white_label_favicon;
                $preferences->default_results_per_page = $_POST['default_results_per_page'];
                $preferences->default_order_type = $_POST['default_order_type'];
                $preferences->links_default_order_by = $_POST['links_default_order_by'];
                $preferences->qr_codes_default_order_by = $_POST['qr_codes_default_order_by'];
                $preferences->projects_default_order_by = $_POST['projects_default_order_by'];
                $preferences->pixels_default_order_by = $_POST['pixels_default_order_by'];
                $preferences->domains_default_order_by = $_POST['domains_default_order_by'];
                $preferences->signatures_default_order_by = $_POST['signatures_default_order_by'];
                $preferences->splash_pages_default_order_by = $_POST['splash_pages_default_order_by'];
                $preferences->data_default_order_by = $_POST['data_default_order_by'];
                $preferences->payment_processors_default_order_by = $_POST['payment_processors_default_order_by'];
                $preferences->guests_payments_default_order_by = $_POST['guests_payments_default_order_by'];

                $preferences->documents_default_order_by = $_POST['documents_default_order_by'];
                $preferences->images_default_order_by = $_POST['images_default_order_by'];
                $preferences->transcriptions_default_order_by = $_POST['transcriptions_default_order_by'];
                $preferences->syntheses_default_order_by = $_POST['syntheses_default_order_by'];
                $preferences->chats_default_order_by = $_POST['chats_default_order_by'];

                $preferences->openai_api_key = $_POST['openai_api_key'];

                $preferences->links_auto_copy_link = $_POST['links_auto_copy_link'];
                $preferences->links_autosave_settings = $_POST['links_autosave_settings'];

                $preferences->excluded_ips = $_POST['excluded_ips'];
