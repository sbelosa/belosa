...
<?php
$fcc_qr_editor_steps = [
    ['selector' => '#fcc_qr_editor_step_intro', 'title' => l('qr_codes.editor.tour.intro_title'), 'text' => l('qr_codes.editor.tour.intro_text')],
    ['selector' => '#fcc_qr_editor_step_type', 'title' => l('qr_codes.editor.tour.type_title'), 'text' => l('qr_codes.editor.tour.type_text')],
    ['selector' => '#fcc_qr_editor_step_basics', 'title' => l('qr_codes.editor.tour.basics_title'), 'text' => l('qr_codes.editor.tour.basics_text')],
    ['selector' => '#fcc_qr_editor_step_style', 'title' => l('qr_codes.editor.tour.style_title'), 'text' => l('qr_codes.editor.tour.style_text')],
    ['selector' => '#fcc_qr_editor_step_colors', 'title' => l('qr_codes.editor.tour.colors_title'), 'text' => l('qr_codes.editor.tour.colors_text')],
    ['selector' => '#fcc_qr_editor_step_frame', 'title' => l('qr_codes.editor.tour.frame_title'), 'text' => l('qr_codes.editor.tour.frame_text')],
    ['selector' => '#fcc_qr_editor_step_branding', 'title' => l('qr_codes.editor.tour.branding_title'), 'text' => l('qr_codes.editor.tour.branding_text')],
    ['selector' => '#fcc_qr_editor_step_options', 'title' => l('qr_codes.editor.tour.options_title'), 'text' => l('qr_codes.editor.tour.options_text')],
    ['selector' => '#fcc_qr_editor_step_preview', 'title' => l('qr_codes.editor.tour.preview_title'), 'text' => l('qr_codes.editor.tour.preview_text')],
    ['selector' => '#fcc_qr_editor_step_download', 'title' => l('qr_codes.editor.tour.download_title'), 'text' => l('qr_codes.editor.tour.download_text')],
    ['selector' => '#fcc_qr_editor_step_save', 'title' => l('qr_codes.editor.tour.save_title'), 'text' => l('qr_codes.editor.tour.save_text')],
];
?>
...
<div class="container">
    ...
    <div class="d-print-none">
        ...
        <div class="fcc-qr-editor-rail mb-3">
            <a href="#" class="fcc-qr-editor-launch" data-fcc-start-qr-editor-tour>
    ...
    <section class="fcc-qr-editor-hero fcc-qr-tour-target" id="fcc_qr_editor_step_intro">
    ...
    <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
        ...
        <div id="fcc_qr_editor_step_type" class="flex-wrap mb-4 btn-group-toggle d-none d-lg-flex fcc-qr-tour-target" data-toggle="buttons">
            ...
            <div class="col-12 col-lg-6 d-print-none mb-5 mb-lg-0">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="fcc_qr_editor_step_basics" class="form-group fcc-qr-tour-target">
    ...
    <?php endforeach ?>
                        ...
                        <button id="fcc_qr_editor_step_style" class="btn btn-block btn-gray-300 my-4 fcc-qr-tour-target" type="button" data-toggle="collapse" data-target="#style_container" aria-expanded="false" aria-controls="style_container">
                        ...
                        <button id="fcc_qr_editor_step_colors" class="btn btn-block btn-gray-300 my-4 fcc-qr-tour-target" type="button" data-toggle="collapse" data-target="#colors_container" aria-expanded="false" aria-controls="colors_container">
                        ...
                        <button id="fcc_qr_editor_step_frame" class="btn btn-block btn-gray-300 my-4 fcc-qr-tour-target" type="button" data-toggle="collapse" data-target="#frame_container" aria-expanded="false" aria-controls="frame_container">
                        ...
                        <button id="fcc_qr_editor_step_branding" class="btn btn-block btn-gray-300 my-4 fcc-qr-tour-target" type="button" data-toggle="collapse" data-target="#branding_container" aria-expanded="false" aria-controls="branding_container">
                        ...
                        <button id="fcc_qr_editor_step_options" class="btn btn-block btn-gray-300 my-4 fcc-qr-tour-target" type="button" data-toggle="collapse" data-target="#options_container" aria-expanded="false" aria-controls="options_container">
                        ...
                        <button id="fcc_qr_editor_step_save" type="submit" name="submit" class="btn btn-block btn-primary mt-4 fcc-qr-tour-target"><?= l('global.update') ?></button>
            ...
            <div class="col-12 col-lg-6">
                <div class="sticky">
                    <div class="mb-4 fcc-qr-tour-target" id="fcc_qr_editor_step_preview">
                        <div class="card">
                            <div class="card-body">
                    ...
                    <div class="row mb-4 d-print-none fcc-qr-tour-target" id="fcc_qr_editor_step_download">
...
<div class="fcc-qr-tour-backdrop" id="fcc_qr_editor_backdrop"></div>
<div class="fcc-qr-tour-popover" id="fcc_qr_editor_popover" aria-live="polite">
    <div class="fcc-qr-tour-progress" id="fcc_qr_editor_progress">1 / <?= count($fcc_qr_editor_steps) ?></div>
    <div class="fcc-qr-tour-title" id="fcc_qr_editor_title"></div>
    <div class="fcc-qr-tour-text" id="fcc_qr_editor_text"></div>
    <div class="fcc-qr-tour-actions">
        <button type="button" class="btn btn-link text-muted px-0" id="fcc_qr_editor_skip"><?= l('dashboard.tour.skip') ?></button>
        <div class="fcc-qr-tour-actions-main">
            <button type="button" class="btn btn-outline-light" id="fcc_qr_editor_prev"><?= l('dashboard.tour.prev') ?></button>
            <button type="button" class="btn btn-primary" id="fcc_qr_editor_next"><?= l('dashboard.tour.next') ?></button>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', () => {
    const storageKey = 'fcc_qr_editor_update_tour_seen_v1';
    const steps = <?= json_encode($fcc_qr_editor_steps, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES) ?>;
    const backdrop = document.getElementById('fcc_qr_editor_backdrop');
    const popover = document.getElementById('fcc_qr_editor_popover');
    const title = document.getElementById('fcc_qr_editor_title');
    const text = document.getElementById('fcc_qr_editor_text');
    const progress = document.getElementById('fcc_qr_editor_progress');
    const prevButton = document.getElementById('fcc_qr_editor_prev');
    const nextButton = document.getElementById('fcc_qr_editor_next');
    const skipButton = document.getElementById('fcc_qr_editor_skip');
    const startButtons = document.querySelectorAll('[data-fcc-start-qr-editor-tour]');
