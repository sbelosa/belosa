                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <input id="billing_phone" type="text" name="billing_phone" class="form-control <?= \Altum\Alerts::has_field_errors('billing_phone') ? 'is-invalid' : null ?>" value="<?= $this->user->billing->phone ?>" placeholder="385911234567" />
