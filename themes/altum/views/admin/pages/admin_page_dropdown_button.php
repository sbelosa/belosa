...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <?php if($english_language && ($data->language ?? null) !== $english_language): ?>
            <a class="dropdown-item" href="<?= url('admin/page-create-english/' . $data->id . '?global_token=' . \Altum\Csrf::get('global_token')) ?>"><i class="fas fa-fw fa-sm fa-language mr-2"></i> Create English Draft</a>
        <?php endif ?>
        <!-- /Custom code: FC-2026-03-30 -->
        <a class="dropdown-item" href="<?= $data->type == 'internal' ? fc_get_internal_page_url($data->url, $data->language) : $data->url ?>" target="_blank" rel="noreferrer"><i class="fas fa-fw fa-sm fa-eye mr-2"></i> <?= l('global.view') ?></a>
