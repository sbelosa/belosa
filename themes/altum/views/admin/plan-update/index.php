    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="ai_growth_plan_is_enabled" name="ai_growth_plan_is_enabled" type="checkbox" class="custom-control-input" <?= !empty($data->plan->settings->ai_growth_plan_is_enabled) ? 'checked="checked"' : null ?>>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="fcc_ai_is_enabled" name="fcc_ai_is_enabled" type="checkbox" class="custom-control-input" <?= !empty($data->plan->settings->fcc_ai_is_enabled) ? 'checked="checked"' : null ?>>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="fcc_coach_is_enabled" name="fcc_coach_is_enabled" type="checkbox" class="custom-control-input" <?= !empty($data->plan->settings->fcc_coach_is_enabled) ? 'checked="checked"' : null ?>>
