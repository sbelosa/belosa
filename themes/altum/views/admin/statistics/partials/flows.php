...
<div class="card mb-5">
    <div class="card-body">
        ...
        <div class="chart-container <?= $data->total['flows'] ? null : 'd-none' ?>">
            <canvas id="flows"></canvas>
        </div>
        <?= $data->total['flows'] ? null : include_view(THEME_PATH . 'views/partials/no_chart_data.php', ['has_wrapper' => false]); ?>
    </div>
</div>
