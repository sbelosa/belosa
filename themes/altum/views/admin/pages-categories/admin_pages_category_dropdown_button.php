...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <?php if($english_language && ($data->language ?? null) !== $english_language): ?>
            <a class="dropdown-item" href="<?= url('admin/pages-category-create-english/' . $data->id . '?global_token=' . \Altum\Csrf::get('global_token')) ?>"><i class="fas fa-fw fa-sm fa-language mr-2"></i> Create English Category</a>
        <?php endif ?>
