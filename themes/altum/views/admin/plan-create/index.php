    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div>
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="vip_funnel_core_is_enabled" name="vip_funnel_core_is_enabled" type="checkbox" class="custom-control-input">
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="branded_button_is_enabled" name="branded_button_is_enabled" type="checkbox" class="custom-control-input">
