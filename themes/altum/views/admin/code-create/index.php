...
<div class="card <?= \Altum\Alerts::has_field_errors() ? 'border-danger' : null ?>">
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div class="form-group custom-control custom-switch">
                <input id="is_scheduled" name="is_scheduled" type="checkbox" class="custom-control-input">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input
                                    ...
                                    class="form-control"
                                    name="start_datetime"
                                    value="<?= \Altum\Date::get($data->values['start_datetime'], 1) ?>"
                                    autocomplete="off"
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input
                                    ...
                                    class="form-control"
                                    name="end_datetime"
                                    value="<?= \Altum\Date::get($data->values['end_datetime'], 1) ?>"
                                    autocomplete="off"
                                    data-daterangepicker
                            >
                        </div>
