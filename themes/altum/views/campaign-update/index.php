        ...
        <div class="card-body">
            ...
            <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <select id="website_id" name="website_id" class="form-control <?= \Altum\Alerts::has_field_errors('website_id') ? 'is-invalid' : null ?>" required="required" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                        <?php foreach($data->websites as $website): ?>
                            <option value="<?= $website->website_id ?>" <?= $data->campaign->website_id == $website->website_id ? 'selected="selected"' : null ?>><?= $website->name . ' - ' . $website->host . $website->path ?></option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="form-group" data-character-counter="input">
                    ...
                    <input type="text" id="title" name="title" class="form-control <?= \Altum\Alerts::has_field_errors('title') ? 'is-invalid' : null ?>" value="<?= $data->campaign->title ?>" maxlength="64" required="required" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                ...
                <div class="form-group" data-character-counter="input">
                    ...
                    <input type="text" id="description" name="description" value="<?= $data->campaign->description ?>" class="form-control <?= \Altum\Alerts::has_field_errors('description') ? 'is-invalid' : null ?>" maxlength="128" required="required" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="url" name="url" value="<?= $data->campaign->url ?>" class="form-control <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                ...
                <div class="form-group" data-file-image-input-wrapper data-file-input-wrapper-size-limit="<?= settings()->websites->campaign_image_size_limit ?>" data-file-input-wrapper-size-limit-error="<?= sprintf(l('global.error_message.file_size_limit'), settings()->websites->campaign_image_size_limit) ?>">
                    ...
                    <?= include_view(THEME_PATH . 'views/partials/file_image_input.php', ['uploads_file_key' => 'websites_campaigns_images', 'file_key' => 'image', 'already_existing_image' => $data->campaign->image, 'input_data' => ($data->campaign->status == 'sent' ? 'disabled="disabled"' : null) . ' data-crop data-aspect-ratio="1.5"']) ?>
                ...
                <div class="form-group">
                    ...
                    <select id="segment" name="segment" class="form-control <?= \Altum\Alerts::has_field_errors('segment') ? 'is-invalid' : null ?>" required="required" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                        ...
                        <optgroup label="<?= l('campaigns.segment.saved') ?>">
                            ...
                            <option value="<?= $segment->segment_id ?>" <?= $data->campaign->segment == $segment->segment_id ? 'selected="selected"' : null ?> data-website-id="<?= $segment->website_id ?>"><?= $segment->name ?></option>
                            <?php endforeach ?>
                        </optgroup>
                        <?php endif ?>
                    </select>
                ...
                <div class="form-group" data-segment="custom">
                    ...
                    <input type="text" id="subscribers_ids" name="subscribers_ids" value="<?= $data->campaign->subscribers_ids ?>" class="form-control <?= \Altum\Alerts::has_field_errors('subscribers_ids') ? 'is-invalid' : null ?>" placeholder="<?= l('campaigns.subscribers_ids_placeholder') ?>" required="required" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                ...
                <div class="form-group" data-segment="filter">
                    ...
                    <input type="text" id="filters_cities" name="filters_cities" value="<?= implode(',', $data->campaign->settings->filters_cities ?? []) ?>" class="form-control" placeholder="<?= l('segments.cities_placeholder') ?>" />
                        ...
                        <?php foreach(['desktop', 'tablet', 'mobile'] as $device_type): ?>
                            <div class="col-12 col-md-4 mb-3 mb-md-0">
                                <div class="custom-control custom-checkbox">
                                    <input id="<?= 'filters_device_type###' . $device_type ?>" name="filters_device_type[]" value="<?= $device_type ?>" type="checkbox" class="custom-control-input" <?= in_array($device_type, $data->campaign->settings->filters_device_type ?? []) ? 'checked="checked"' : null ?> <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                ...
                <div class="form-group" data-segment="filter">
                    ...
                    <select id="filters_operating_systems" name="filters_operating_systems[]" class="custom-select" multiple="multiple" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                        <?php foreach(['iOS', 'Android', 'Windows', 'OS X', 'Linux', 'Ubuntu', 'Chrome OS'] as $os_name): ?>
                            <option value="<?= $os_name ?>" <?= in_array($os_name, $data->campaign->settings->filters_operating_systems ?? []) ? 'selected="selected"' : null ?>><?= $os_name ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                ...
                <div class="form-group" data-segment="filter">
                    ...
                    <select id="filters_browsers" name="filters_browsers[]" class="custom-select" multiple="multiple" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                        <?php foreach(['Chrome', 'Firefox', 'Safari', 'Edge', 'Opera', 'Samsung Internet'] as $browser_name): ?>
                            <option value="<?= $browser_name ?>" <?= in_array($browser_name, $data->campaign->settings->filters_browsers ?? []) ? 'selected="selected"' : null ?>><?= $browser_name ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                ...
                <div class="form-group" data-segment="filter">
                    ...
                    <select id="filters_languages" name="filters_languages[]" class="custom-select" multiple="multiple" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                        <?php foreach(get_locale_languages_array() as $locale => $language): ?>
                            <option value="<?= $locale ?>" <?= in_array($locale, $data->campaign->settings->filters_languages ?? []) ? 'selected="selected"' : null ?>><?= $language ?></option>
                        <?php endforeach ?>
                    </select>
                </div>
                ...
                <div class="form-group" data-segment="filter">
                    ...
                    <input type="text" id="filters_subscribed_on_url" name="filters_subscribed_on_url" value="<?= $data->campaign->settings->filters_subscribed_on_url ?? '' ?>" maxlength="2048" class="form-control" placeholder="<?= l('global.url_placeholder') ?>" />
                ...
                <div class="collapse" data-parent="#form" id="buttons_container">
                    ...
                    <div class="p-3 bg-gray-50 rounded mb-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="button_title_1" name="button_title_1" class="form-control <?= \Altum\Alerts::has_field_errors('button_title_1') ? 'is-invalid' : null ?>" value="<?= $data->campaign->settings->button_title_1 ?>" maxlength="16" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="button_url_1" name="button_url_1" class="form-control <?= \Altum\Alerts::has_field_errors('button_url_1') ? 'is-invalid' : null ?>" value="<?= $data->campaign->settings->button_url_1 ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                    ...
                    <div class="p-3 bg-gray-50 rounded mb-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="button_title_2" name="button_title_2" class="form-control <?= \Altum\Alerts::has_field_errors('button_title_2') ? 'is-invalid' : null ?>" value="<?= $data->campaign->settings->button_title_2 ?>" maxlength="16" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="button_url_2" name="button_url_2" class="form-control <?= \Altum\Alerts::has_field_errors('button_url_2') ? 'is-invalid' : null ?>" value="<?= $data->campaign->settings->button_url_2 ?>" maxlength="512" placeholder="<?= l('global.url_placeholder') ?>" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?> />
                ...
                <div class="collapse" data-parent="#form" id="utm_container">
                    <div class="form-group">
                        ...
                        <input id="utm_source" type="text" class="form-control" name="utm_source" value="<?= $data->campaign->settings->utm->source ?? '' ?>" maxlength="128" placeholder="<?= l('campaigns.utm_source_placeholder') ?>" />
                    </div>

                    <div class="form-group">
                        <label for="utm_medium"><i class="fas fa-fw fa-inbox fa-sm text-muted mr-1"></i> <?= l('campaigns.utm_medium') ?></label>
                        <input id="utm_medium" type="text" class="form-control" name="utm_medium" value="<?= $data->campaign->settings->utm->medium ?? '' ?>" maxlength="128" placeholder="<?= l('campaigns.utm_medium_placeholder') ?>" />
                    </div>

                    <div class="form-group">
                        <label for="utm_campaign"><i class="fas fa-fw fa-bullhorn fa-sm text-muted mr-1"></i> <?= l('campaigns.utm_campaign') ?></label>
                        <input id="utm_campaign" type="text" class="form-control" name="utm_campaign" value="<?= $data->campaign->settings->utm->campaign ?? '' ?>" maxlength="128" placeholder="<?= l('campaigns.utm_campaign_placeholder') ?>" />
                    </div>
                ...
                <div class="collapse" data-parent="#form" id="advanced_container">
                    <div class="form-group custom-control custom-switch">
                        <input id="is_silent" name="is_silent" type="checkbox" class="custom-control-input" <?= $data->campaign->settings->is_silent ? 'checked="checked"' : null?> <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                    ...
                    <div class="form-group custom-control custom-switch">
                        <input id="is_auto_hide" name="is_auto_hide" type="checkbox" class="custom-control-input" <?= $data->campaign->settings->is_auto_hide ? 'checked="checked"' : null?> <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                    ...
                    <div class="form-group">
                        <label for="ttl"><i class="fas fa-fw fa-sm fa-stopwatch text-muted mr-1"></i> <?= l('campaigns.ttl') ?> <span id="ttl_count"></span></label>
                        <select id="ttl" name="ttl" class="form-control <?= \Altum\Alerts::has_field_errors('ttl') ? 'is-invalid' : null ?>" required="required" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                            <?php foreach($data->notifications_ttl as $key => $value): ?>
                                <option value="<?= $key ?>" <?= $data->campaign->settings->ttl == $key ? 'selected="selected"' : null ?>><?= $value ?></option>
                            <?php endforeach ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select id="urgency" name="urgency" class="form-control <?= \Altum\Alerts::has_field_errors('urgency') ? 'is-invalid' : null ?>" required="required" <?= $data->campaign->status == 'sent' ? 'disabled="disabled"' : null ?>>
                            <?php foreach(['low', 'normal', 'high'] as $key): ?>
                                <option value="<?= $key ?>" <?= $data->campaign->settings->urgency == $key ? 'selected="selected"' : null ?>><?= l('campaigns.urgency.' . $key) ?></option>
                            <?php endforeach ?>
                        </select>
