...
<?php $fallback_url = $data->link->settings->fallback_url ?? $data->link->location_url ?? SITE_URL; ?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6">
                            <a href="<?= $fallback_url ?>" data-track-biolink-block-id="<?= $data->link->biolink_block_id ?>" target="<?= $data->link->settings->open_in_new_tab ? '_blank' : '_self' ?>" rel="<?= $data->user->plan_settings->dofollow_is_enabled ? 'dofollow' : 'nofollow' ?>" class="btn btn-block btn-primary">
