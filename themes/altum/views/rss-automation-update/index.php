        ...
        <div class="card-body">
            ...
            <form id="rss_automation_update" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group" data-character-counter="input">
                    ...
                    <input type="text" id="title" name="title" class="form-control <?= \Altum\Alerts::has_field_errors('title') ? 'is-invalid' : null ?>" value="<?= $data->rss_automation->title ?>" maxlength="64" required="required" />
                ...
                <div class="collapse" data-parent="#rss_automation_update" id="rss_container">
                    ...
                    <div class="form-group custom-control custom-switch">
                        <input id="disable_rss_automation_on_fail" name="disable_rss_automation_on_fail" type="checkbox" class="custom-control-input" <?= ($data->rss_automation->settings->disable_rss_automation_on_fail ?? true) ? 'checked="checked"' : null?>>
                        <label class="custom-control-label" for="disable_rss_automation_on_fail"><?= l('rss_automations.disable_rss_automation_on_fail') ?></label>
                        <small class="form-text text-muted"><?= l('rss_automations.disable_rss_automation_on_fail_help') ?></small>
                    </div>
                </div>
