    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="form" action="" method="post" role="form" enctype="multipart/form-data">
                ...
                <div class="form-group custom-control custom-switch">
                    <input id="auto_apply_to_matching" name="auto_apply_to_matching" type="checkbox" class="custom-control-input" <?= $data->values['auto_apply_to_matching'] ? 'checked="checked"' : null?>>
                    <label class="custom-control-label" for="auto_apply_to_matching"><?= l('flows.auto_apply_to_matching') ?></label>
                    <small class="form-text text-muted"><?= l('flows.auto_apply_to_matching_help') ?></small>
                </div>
