...
<!-- Custom code: FC-2026-03-05: Albania/Kosovo Forever Living full styling update form -->
<form id="<?= 'update_biolink_block_' . $row->biolink_block_id ?>" name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="alert alert-info">
        <i class="fas fa-fw fa-circle-info mr-1"></i> <?= l('create_biolink_link_forever_living_alb_kosovo_modal.info') ?>
    </div>
