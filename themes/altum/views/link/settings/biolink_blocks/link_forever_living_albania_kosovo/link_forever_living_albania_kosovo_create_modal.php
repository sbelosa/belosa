...
<!-- Custom code: FC-2026-03-05: Albania/Kosovo Forever Living create modal alias for legacy key -->
<div class="modal fade" id="create_biolink_link_forever_living_albania_kosovo" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="create_biolink_link_forever_living_albania_kosovo" method="post" role="form">
