...
<form id="<?= 'update_biolink_block_' . $row->biolink_block_id ?>" name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <div class="collapse" data-parent="<?= '#update_biolink_block_' . $row->biolink_block_id ?>" id="<?= 'product_settings_container_' . $row->biolink_block_id ?>">
        <div class="form-group">
            <label for="<?= 'product_file_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-file text-muted mr-1"></i> <?= l('biolink_product.file') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'product_title_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-heading text-muted mr-1"></i> <?= l('biolink_product.title') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'product_description_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-align-left text-muted mr-1"></i> <?= l('biolink_product.description') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'product_price_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-tag text-muted mr-1"></i> <?= l('biolink_product.price') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'product_minimum_price_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-hand-holding-usd text-muted mr-1"></i> <?= l('biolink_product.minimum_price') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'product_currency_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-coins text-muted mr-1"></i> <?= l('biolink_product.currency') ?></label>
            <select id="<?= 'product_currency_' . $row->biolink_block_id ?>" name="currency" class="custom-select">
        ...
        <div class="form-group">
            <label for="<?= 'product_thank_you_title_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-heart text-muted mr-1"></i> <?= l('biolink_donation.thank_you_title') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'product_thank_you_description_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-comment-alt text-muted mr-1"></i> <?= l('biolink_donation.thank_you_description') ?></label>
        ...
        <div class="form-group">
            <label for="<?= 'product_thank_you_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-link text-muted mr-1"></i> <?= l('biolink_donation.thank_you_url') ?></label>
            <input type="url" id="<?= 'product_thank_you_url_' . $row->biolink_block_id ?>" name="thank_you_url" class="form-control" value="<?= $row->settings->thank_you_url ?? null ?>" placeholder="<?= l('global.url_placeholder') ?>" maxlength="<?= $data->biolink_blocks['product']['fields']['thank_you_url']['max_length'] ?>" />
            <small class="form-text text-muted"><?= l('biolink_donation.thank_you_url_help') ?></small>
        </div>

        <div class="mb-3">
            <div class="d-flex flex-wrap flex-row justify-content-between">
                <label for="<?= 'product_payment_processors_ids_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-sm fa-credit-card text-muted mr-1"></i> <?= l('payment_processors.payment_processors_ids') ?></label>
    ...
    <div class="collapse" data-parent="<?= '#update_biolink_block_' . $row->biolink_block_id ?>" id="<?= 'product_data_container_' . $row->biolink_block_id ?>">
