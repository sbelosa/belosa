...
<form id="<?= 'update_biolink_block_' . $row->biolink_block_id ?>" name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>">
    ...
    <input type="hidden" name="block_type" value="loading" />
    <input type="hidden" name="biolink_block_id" value="<?= $row->biolink_block_id ?>" />

    <div class="notification-container"></div>

    <div class="form-group">
        <label for="<?= 'loading_number_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-spinner fa-sm text-muted mr-1"></i> <?= l('biolink_loading.number') ?></label>
        <input id="<?= 'loading_number_' . $row->biolink_block_id ?>" type="number" name="number" min="1" class="form-control" value="<?= $row->settings->number ?>" max="100" required="required" />
    </div>

    <div class="form-group">
        <label for="<?= 'loading_number_prefix_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-font fa-sm text-muted mr-1"></i> <?= l('biolink_loading.number_prefix') ?></label>
        <input id="<?= 'loading_number_prefix_' . $row->biolink_block_id ?>" type="text" name="number_prefix" class="form-control" value="<?= $row->settings->number_prefix ?>" maxlength="32" />
    </div>

    <div class="form-group">
        <label for="<?= 'loading_number_suffix_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-font fa-sm text-muted mr-1"></i> <?= l('biolink_loading.number_suffix') ?></label>
        <input id="<?= 'loading_number_suffix_' . $row->biolink_block_id ?>" type="text" name="number_suffix" class="form-control" value="<?= $row->settings->number_suffix ?>" maxlength="32" />
    </div>

    <div class="form-group">
        <label for="<?= 'loading_description_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paragraph fa-sm text-muted mr-1"></i> <?= l('biolink_link.description') ?></label>
        <textarea id="<?= 'loading_description_' . $row->biolink_block_id ?>" type="text" name="description" class="form-control" maxlength="256" required="required"><?= $row->settings->description ?></textarea>
    </div>

    <div class="form-group">
        <label for="<?= 'loading_location_url_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-link fa-sm text-muted mr-1"></i> <?= l('biolink_link.location_url') ?></label>
        <input id="<?= 'loading_location_url_' . $row->biolink_block_id ?>" type="text" class="form-control" name="location_url" value="<?= $row->location_url ?>" maxlength="2048" placeholder="<?= l('global.url_placeholder') ?>" />
    </div>

    <div class="form-group custom-control custom-switch">
        <input
                id="<?= 'loading_open_in_new_tab_' . $row->biolink_block_id ?>"
                name="open_in_new_tab" type="checkbox"
                class="custom-control-input"
                <?= $row->settings->open_in_new_tab ? 'checked="checked"' : null ?>
        >
        <label class="custom-control-label" for="<?= 'loading_open_in_new_tab_' . $row->biolink_block_id ?>"><?= l('biolink_link.open_in_new_tab') ?></label>
    </div>

    <div class="form-group custom-control custom-switch">
        <input
                id="<?= 'loading_bar_is_striped_' . $row->biolink_block_id ?>"
                name="bar_is_striped" type="checkbox"
                class="custom-control-input"
                <?= $row->settings->bar_is_striped ? 'checked="checked"' : null ?>
        >
        <label class="custom-control-label" for="<?= 'loading_bar_is_striped_' . $row->biolink_block_id ?>"><?= l('biolink_loading.bar_is_striped') ?></label>
    </div>

    <div class="form-group custom-control custom-switch">
        <input
                id="<?= 'loading_bar_is_animated_' . $row->biolink_block_id ?>"
                name="bar_is_animated" type="checkbox"
                class="custom-control-input"
                <?= $row->settings->bar_is_animated ? 'checked="checked"' : null ?>
        >
        <label class="custom-control-label" for="<?= 'loading_bar_is_animated_' . $row->biolink_block_id ?>"><?= l('biolink_loading.bar_is_animated') ?></label>
    </div>

    <div class="form-group">
        <label for="<?= 'loading_number_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_loading.number_color') ?></label>
        <input id="<?= 'loading_number_color_' . $row->biolink_block_id ?>" type="hidden" name="number_color" class="form-control" value="<?= $row->settings->number_color ?>" required="required" />
        <div class="number_color_pickr"></div>
    </div>

    <div class="form-group">
        <label for="<?= 'loading_bar_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_loading.bar_color') ?></label>
        <input id="<?= 'loading_bar_color_' . $row->biolink_block_id ?>" type="hidden" name="bar_color" class="form-control" value="<?= $row->settings->bar_color ?>" required="required" />
        <div class="bar_color_pickr"></div>
    </div>

    <div class="form-group">
        <label for="<?= 'loading_description_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-paint-brush fa-sm text-muted mr-1"></i> <?= l('biolink_link.description_color') ?></label>
        <input id="<?= 'loading_description_color_' . $row->biolink_block_id ?>" type="hidden" name="description_color" class="form-control" value="<?= $row->settings->description_color ?>" required="required" />
        <div class="description_color_pickr"></div>
    </div>

    <div class="form-group" data-range-counter data-range-counter-suffix="px">
        <label for="<?= 'loading_bar_height' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-text-height fa-sm text-muted mr-1"></i> <?= l('biolink_loading.bar_height') ?></label>
        <input id="<?= 'loading_bar_height' . $row->biolink_block_id ?>" type="range" name="bar_height" min="10" max="50" step="1" value="<?= $row->settings->bar_height ?>" class="form-control-range" />
    </div>
    ...
    <div class="form-group">
        <label for="<?= 'loading_background_color_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-fill fa-sm text-muted mr-1"></i> <?= l('biolink_link.background_color') ?></label>
        <input id="<?= 'loading_background_color_' . $row->biolink_block_id ?>" type="hidden" name="background_color" class="form-control" value="<?= $row->settings->background_color ?>" required="required" />
        <div class="background_color_pickr"></div>
    </div>

    <div class="form-group">
        <label for="<?= 'loading_animation_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-film fa-sm text-muted mr-1"></i> <?= l('biolink_link.animation') ?></label>
        <select id="<?= 'loading_animation_' . $row->biolink_block_id ?>" name="animation" class="custom-select">
    ...
    <div class="form-group" data-animation="<?= implode(',', require APP_PATH . 'includes/biolink_animations.php') ?>">
        <label for="<?= 'loading_animation_runs_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-play-circle fa-sm text-muted mr-1"></i> <?= l('biolink_link.animation_runs') ?></label>
        <select id="<?= 'loading_animation_runs_' . $row->biolink_block_id ?>" name="animation_runs" class="custom-select">
    ...
    <div class="collapse" data-parent="<?= '#update_biolink_block_' . $row->biolink_block_id ?>" id="<?= 'border_container_' . $row->biolink_block_id ?>">
        <div class="form-group" data-range-loading data-range-loading-suffix="px">
    ...
    <div class="collapse" data-parent="<?= '#update_biolink_block_' . $row->biolink_block_id ?>" id="<?= 'display_settings_container_' . $row->biolink_block_id ?>">
        <div <?= $this->user->plan_settings->temporary_url_is_enabled ? null : get_plan_feature_disabled_info() ?>>
            <div class="<?= $this->user->plan_settings->temporary_url_is_enabled ? null : 'container-disabled' ?>">
                <div class="form-group custom-control custom-switch">
                    <input
                            id="<?= 'loading_schedule_' . $row->biolink_block_id ?>"
                            name="schedule" type="checkbox"
                            class="custom-control-input"
                        <?= !empty($row->start_date) && !empty($row->end_date) ? 'checked="checked"' : null ?>
                        <?= $this->user->plan_settings->temporary_url_is_enabled ? null : 'disabled="disabled"' ?>
                    >
                    <label class="custom-control-label" for="<?= 'loading_schedule_' . $row->biolink_block_id ?>"><?= l('link.settings.schedule') ?></label>
            ...
            <div <?= $this->user->plan_settings->temporary_url_is_enabled ? null : get_plan_feature_disabled_info() ?>>
                <div class="<?= $this->user->plan_settings->temporary_url_is_enabled ? null : 'container-disabled' ?>">
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                <label for="<?= 'loading_start_date_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-hourglass-start fa-sm text-muted mr-1"></i> <?= l('link.settings.start_date') ?></label>
                                <input
                                        id="<?= 'loading_start_date_' . $row->biolink_block_id ?>"
                                        type="text"
                                        class="form-control"
                                        name="start_date"
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="<?= 'loading_end_date_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-hourglass-end fa-sm text-muted mr-1"></i> <?= l('link.settings.end_date') ?></label>
                                <input
                                        id="<?= 'loading_end_date_' . $row->biolink_block_id ?>"
                                        type="text"
                                        class="form-control"
                                        name="end_date"
        ...
        <div class="form-group">
            <label for="<?= 'loading_display_countries_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= l('global.countries') ?></label>
            <select id="<?= 'loading_display_countries_' . $row->biolink_block_id ?>" name="display_countries[]" class="custom-select" multiple="multiple">
        ...
        <div class="form-group">
            <label for="<?= 'loading_display_devices_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-laptop fa-sm text-muted mr-1"></i> <?= l('biolink_link.display_devices') ?></label>
            <select id="<?= 'loading_display_devices_' . $row->biolink_block_id ?>" name="display_devices[]" class="custom-select" multiple="multiple">
        ...
        <div class="form-group">
            <label for="<?= 'loading_display_languages_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-language fa-sm text-muted mr-1"></i> <?= l('biolink_link.display_languages') ?></label>
            <select id="<?= 'loading_display_languages_' . $row->biolink_block_id ?>" name="display_languages[]" class="custom-select" multiple="multiple">
        ...
        <div class="form-group">
            <label for="<?= 'loading_display_operating_systems_' . $row->biolink_block_id ?>"><i class="fas fa-fw fa-server fa-sm text-muted mr-1"></i> <?= l('biolink_link.display_operating_systems') ?></label>
            <select id="<?= 'loading_display_operating_systems_' . $row->biolink_block_id ?>" name="display_operating_systems[]" class="custom-select" multiple="multiple">
