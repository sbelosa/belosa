...
<form id="<?= 'update_biolink_block_' . $row->biolink_block_id ?>" name="update_biolink_" method="post" role="form" data-type="<?= $row->type ?>" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea id="<?= 'map_markers_' . $row->biolink_block_id ?>" class="form-control" name="markers" placeholder="<?= l('biolink_map.markers_placeholder') ?>" maxlength="1024"><?= $row->settings->markers ?></textarea>
