...
$assertions = [
    ...
    'qualified members receive the confirmed VIP WhatsApp link' => str_contains($helper, 'BGWXMZOrPCf3FjgoaRXVXv') && str_contains($view, 'Pridruži se VIP grupi'),
...
$rule_assertions = [
    ...
    'VIP group and first Marketing plan are available in the qualified program state' => str_contains($vip_active['whatsapp_group_url'], 'BGWXMZOrPCf3FjgoaRXVXv') && ($vip_active['marketing_plan']['weekday'] ?? 0) === 7 && ($vip_active['marketing_plan']['time_label'] ?? '') === '18:00' && ($vip_active['marketing_plan']['next_at_display'] ?? '') === 'nedjelja, 06.09.2026. u 18:00' && ($vip_active['marketing_plan']['url'] ?? '') === 'https://forevercard.club/vip-edukacija',
